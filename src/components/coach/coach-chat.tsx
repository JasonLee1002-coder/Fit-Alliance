...
import { CoachMascot } from '@/components/shared/mascots'
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-6rem)] lg:h-[calc(100vh-3rem)]">
      ...
      <div className="flex items-center gap-3 pb-4 border-b border-gray-100">
        <img src={pub('/char-coaches.png')} alt="AI教練" className="w-11 h-11 drop-shadow" />
        <div>
      ...
      <div ref={scrollRef} className="flex-1 overflow-y-auto py-4 space-y-4">
          ...
          >
            <div className={`flex ${message.role === 'user' ? 'justify-end' : 'justify-start'}`}>
              {message.role === 'assistant' && (
                <img src={pub('/char-coaches.png')} alt="" className="w-8 h-8 mr-1 flex-shrink-0 mt-1 drop-shadow" />
              )}
              <div
        ...
        {isStreaming && allMessages[allMessages.length - 1]?.role !== 'assistant' && (
          <div className="flex justify-start">
            <img src={pub('/char-coaches.png')} alt="" className="w-8 h-8 mr-1 drop-shadow yuzu-glow-pulse" />
